...
from src.models.SpectralGPT.util.video_vit import Attention, Block, PatchEmbed, Linear_Block, Linear_Attention
...
class VisionTransformer(nn.Module):
    ...
    def forward(self, x):
        # embed patches
        # x = x[:, :-1, :, :]  # Slice the tensor to adjust the input dimensions.
        # print(x.shape)
