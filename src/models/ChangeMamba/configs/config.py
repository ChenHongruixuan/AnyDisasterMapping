...
def get_config(args=None, cfg_file=None, opts=None):
    """Get a yacs CfgNode object with default values.

    Supports two calling modes:
    - get_config(args)           — legacy: reads args.cfg and args.opts
    - get_config(cfg_file=path)  — new: directly pass config file path
    """
    config = _C.clone()
